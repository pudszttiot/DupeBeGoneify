...
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QTextEdit, QLabel, QLineEdit, QStatusBar, QAction, QFileDialog, QProgressBar, QMessageBox
...
class SpotifyDuplicateFinderApp(QMainWindow):
    ...
    def remove_duplicates(self):
        ...
        self.status_bar.showMessage(f'Duplicate songs removed. New playlist contains {len(non_duplicate_tracks)} songs.')
