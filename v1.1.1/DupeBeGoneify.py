    ...
    def apply_stylesheets(self):
        ...
        try:
            ...
            with open("menu_bar.qss", "r") as file:
                menu_bar_styles = file.read()
            
            with open("general_styles.qss", "r") as file:
                general_styles = file.read()
            
            with open("push_button_styles.qss", "r") as file:
                button_styles = file.read()

            # Combine the stylesheets
            combined_styles = menu_bar_styles + "\n" + general_styles + "\n" + button_styles
            
            # Apply the combined stylesheet
            self.setStyleSheet(combined_styles)
        except Exception as e:
            QMessageBox.critical(self, "Stylesheet Error", f"Error loading stylesheet: {e}")
