...
class SpotifyDuplicateFinderApp(QMainWindow):
    ...
    def initUI(self):
        ...
        )  # Adjust the color code to match the desired theme
        ...
        vertical_header_stylesheet = (
            "QHeaderView::section { background-color: #191414; color: #1DB954; }"
        )
        ...
        if file_name:
            try:
                with open(file_name, "w", encoding="utf-8") as file:
                    ...
                    # Fetched Playlist section
                    file.write("<h2 style='color: #bbe4ff;'>Fetched Playlist</h2>\n")
                    file.write("<table border='1'>\n")
                    file.write("<tr><th>Song</th><th>Artist</th><th>Album</th></tr>\n")
                    for track in self.fetched_data:
                        song = track["name"]
